   ...
   /*  const [isOpen, setIsOpen] = useState(false);
    ...
    return (
        ...
        <>
            ...
            <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 lg:bg-white dark:bg-gray-800">
                ...
                <ul className="pt-2 mt-2 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                    {/* <li>
                        <div className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            ...
                            <span className="ms-3 text-lg">Filtros</span>
                        </div>
                    </li> */}
                    <li>
                        <span className="ms-3 md:text-lg">Categoria</span>
                        <div className="w-40 ml-5 my-1 text-gray-900 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                ...
                <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                    <li className="flex justify-between border-b border-gray-200 pb-2">
                        <p className="md:text-lg text-nowrap ml-3">Envio Fast⚡</p>
                    ...
                    <li className="flex justify-between my-2 border-b border-gray-200 pb-2">
                        <p className="md:text-lg text-nowrap ml-3">Envio Gratis</p>
                        <label className="inline-flex items-center cursor-pointer">
                        <input type="checkbox" defaultValue="" className="sr-only peer" />
                        <div className="relative w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                        </label>
                    ...
                    <li className="flex justify-between">
                        <p className="md:text-lg text-nowrap ml-3">Cuotas Sin Interes</p>
                        <label className="inline-flex items-center cursor-pointer">
                        <input type="checkbox" defaultValue="" className="sr-only peer" />
                        <div className="relative w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                        </label>
                ...
                <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                    <h3 className="md:text-lg mb-1 ml-3">Precio</h3>
                ...
                <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                    <h3 className="md:text-lg ml-3">A - Z</h3>
                    <div className="filter-section px-3">
                        <div className="filter-buttons grid grid-cols-4 bg-gray-100/50 md:gap-1 py-1">
        ...
        {/* <div className="p-4 lg:ml-64">
            <div className="w-full flex justify-end">
                ...
                type="button" className="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
